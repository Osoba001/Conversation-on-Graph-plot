    ...
    public partial class InitialCreation : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GraphPlots", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GraphPlots_RMGroups_GroupId",
                        column: x => x.GroupId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GraphPlotId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Conversations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Conversations_GraphPlots_GraphPlotId",
                        column: x => x.GraphPlotId,
                        principalTable: "GraphPlots",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Conversations_GraphPlotId",
                table: "Conversations",
                column: "GraphPlotId");

            migrationBuilder.CreateIndex(
                name: "IX_GraphPlots_GroupId",
                table: "GraphPlots",
                column: "GroupId");
