        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PlotInitiatorId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Plots", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Plots_Users_PlotInitiatorId",
                        column: x => x.PlotInitiatorId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GraphPlotId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Conversation", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Conversation_Plots_GraphPlotId",
                        column: x => x.GraphPlotId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Conversation_GraphPlotId",
                table: "Conversation",
                column: "GraphPlotId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Plots_PlotInitiatorId",
                table: "Plots",
                column: "PlotInitiatorId");
        }
